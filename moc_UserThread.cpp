...
QT_MOC_LITERAL(9, 94, 10), // "quitThread"
QT_MOC_LITERAL(10, 105, 8), // "readData"
QT_MOC_LITERAL(11, 114, 13), // "handlePackage"
QT_MOC_LITERAL(12, 128, 14) // "onDisconnected"

    },
    "UserThread\0error\0\0QTcpSocket::SocketError\0"
    "socketError\0readPackage\0sendMsg\0qintptr\0"
    "std::string\0quitThread\0readData\0"
    "handlePackage\0onDisconnected"
};
...
void UserThread::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 3: _t->quitThread(); break;
        case 4: _t->readData(); break;
        case 5: _t->handlePackage(); break;
        ...
        {
            typedef void (UserThread::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&UserThread::quitThread)) {
                *result = 3;
                return;
            }
        }
...
const QMetaObject UserThread::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_UserThread.data,
